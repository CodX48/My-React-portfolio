...
function _Container(){
    return(
        ...
        <div class="relative h-screen w-full bg-slate-100 overflow-x-hidden dark:bg-slate-950">
        ...
        <div className="lg:w-[80%] md:w-[80%] sm:w-[100%] max-sm:w-[100%] absolute p-[17px] lg:px-10 md:px-7 sm:px-5 max-sm:px-5 pt-11">
        <_Header />
