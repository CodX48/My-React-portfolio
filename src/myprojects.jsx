...
function ReposList() {
    ...
    return(
        ...
        <div className="z-20 absolute  animate-[--my-bounce] duration-1000 bg-sky-700/60 -rotate-45 right-[15%] w-[130px] h-[150px] top-[10%] rounded-full blur-2xl" style={{"--my-bounce": "bounce 3s infinite alternate"}}></div>
        <div className=" absolute animate-[--my-bounce] duration-1000 bg-pink-900/50 -rotate-45 right-[15%] w-[100px] h-[100px] top-[10%] rounded-full blur-3xl" style={{"--my-bounce": "bounce 4s infinite alternate"}}></div>
        <div className="z-30 absolute animate-[--my-bounce] duration-1000 bg-pink-900 -rotate-90 right-[12%] w-[130px] h-[150px] top-[10%] rounded-full blur-2xl" style={{"--my-bounce": "bounce 2.5s infinite alternate"}}></div>
