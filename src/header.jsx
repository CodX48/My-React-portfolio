...
function _Header(){
    return(
        <div className="flex justify-between items-center px-2">
            ...
            <div className=" flex justify-between gap-3 text-2xl text-zinc-950 cursor-pointer items-center dark:text-zinc-100">
                <i className="hover:text-blue-400"><a href={`${LinkedIn}`} target='_blank'><FaLinkedin  /></a></i>
